...
\begin{figure}[h!]
\includegraphics[width=3in]{figs/muller_pot_traj.pdf}
\caption{The M\"{u}ller potential consists of three metastable wells. We simulated Langevin dynamics on this potential as validation of the new likelihood function.}
